...
def get_run_directory():
    ...
    return f"deepfake_efficientnetB0_{timestamp}"
...
class DeepFakeDetector(nn.Module):
    def __init__(self, freeze_backbone=True):
        ...
        if freeze_backbone:
            ...
            for param in self.efficientnet_b0.features.parameters():
    ...
    def _initialize_weights(self):
        ...
        for m in self.efficientnet_b0.classifier:
